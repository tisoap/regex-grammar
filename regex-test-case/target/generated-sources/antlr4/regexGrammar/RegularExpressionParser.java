...
public class RegularExpressionParser extends Parser {
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					setState(79); match(PIPE);
					setState(80); subExpression(0);
					}
					}
					break;
				default:
	...
	public final GroupContext group() throws RecognitionException {
		...
		try {
			...
			case NUMERICALGROUP:
				enterOuterAlt(_localctx, 1);
				{
				setState(100); numericalGroup();
				}
				break;
			case NAMESTART:
				enterOuterAlt(_localctx, 2);
				{
				setState(101); namedGroup();
				}
				break;
			case NOCAPTUREGROUP:
				enterOuterAlt(_localctx, 3);
				{
				setState(102); noCaptureGroup();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final NumericalGroupContext numericalGroup() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(105); match(NUMERICALGROUP);
	...
	public final NamedGroupContext namedGroup() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(109); match(NAMESTART);
			setState(110); groupName();
			setState(111); match(NAMEEND);
	...
	public final NoCaptureGroupContext noCaptureGroup() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(120); match(NOCAPTUREGROUP);
			setState(121); expression(0);
			setState(122); match(CLOSE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final RepetitionContext repetition() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(124); quantified();
			setState(125); quantifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final LazyContext lazy() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(136); lazyOneOrMore();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(137); lazyZeroOrMore();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(138); lazyConditional();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(139); lazyAtLeast();
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(140); lazyBetween();
				}
				break;
			}
		}
	...
	public final GreedyContext greedy() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(143); greedyOneOrMore();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(144); greedyZeroOrMore();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(145); greedyConditional();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(146); greedyAtLeast();
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(147); greedyBetween();
				}
				break;
			}
		}
	...
	public final GreedyBetweenContext greedyBetween() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(169); match(CURLYOPEN);
			setState(170); firstValue();
			setState(171); match(COMMA);
			setState(172); lastValue();
			setState(173); match(CURLYCLOSE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final LazyZeroOrMoreContext lazyZeroOrMore() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(178); match(ASTERISC);
			setState(179); match(QUESTION);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final LazyConditionalContext lazyConditional() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(181); match(QUESTION);
			setState(182); match(QUESTION);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final LazyBetweenContext lazyBetween() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(194); match(CURLYOPEN);
			setState(195); firstValue();
			setState(196); match(COMMA);
			setState(197); lastValue();
			setState(198); match(CURLYCLOSE);
			setState(199); match(QUESTION);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CommentContext comment() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(216); match(COMMENT);
			setState(217); commentText();
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		...
		case 2: return subExpression_sempred((SubExpressionContext)_localctx, predIndex);
		}
		return true;
	}
	...
	public static final String _serializedATN =
		...
		"\2\2\2KI\3\2\2\2LO\3\2\2\2MK\3\2\2\2MN\3\2\2\2N\3\3\2\2\2OM\3\2\2\2PS"+
		...
		"\5\2\2`b\5\6\4\2a_\3\2\2\2be\3\2\2\2ca\3\2\2\2cd\3\2\2\2d\7\3\2\2\2ec"+
