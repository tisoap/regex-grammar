...
- Corrigida definição de classes de caracteres: agora só podem ocorrer dentro de listas
- Testes JUnit de tempo de execução

(13/05/2015)

- Testes JUnit de tradução e de identificação de erros

(09/05/2015)

- Corrigidas acentuações na tradução
...
IVOSAF  - Incontrolável Vontade de Sair Fazendo
